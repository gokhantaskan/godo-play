...
--> statement-breakpoint
ALTER TABLE "game_submission_game_modes" ADD CONSTRAINT "game_submission_game_modes_submission_id_game_submissions_id_fk" FOREIGN KEY ("submission_id") REFERENCES "public"."game_submissions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
